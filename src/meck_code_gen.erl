...
exec(Pid, Mod, Func, Args) ->
    try meck_proc:get_result_spec(Mod, Func, Args) of
        undefined ->
            ...
            %% TODO: Find a way to get a proper stack trace
...
-spec raise(CallerPid::pid(), Mod::atom(), Func::atom(), Args::[any()],
            Class:: exit | error | throw, Reason::any(), Stacktrace::[any()]) ->
        no_return().
raise(Pid, Mod, Func, Args, Class, Reason, Stacktrace) ->
    StackTrace = inject(Mod, Func, Args, Stacktrace),
